...
<template>
    <div class="grid mx-16 mb-24 mt-6 w-full">
        <div class="flex shadow-2xl rounded-lg bg-white">
            ...
            <div class="p-8 pt-4">
                ...
                <div class="font-extrabold text-[28px]">
                    ...
                    <span> | </span>
                    <span>{{ props.hotelData.hotel_city }}</span>
                </div> 
                <!-- สถานที่ตั้ง -->
            ...
            <div class="flex justify-end items-end mb-4 ml-auto mr-4">
                <div class="bg-[#00D35F] p-2.5 text-white rounded-sm font-semibold">2000 บาท / คืน</div>
            </div>
        </div>
    </div>
</template>